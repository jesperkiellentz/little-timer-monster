...
class ProgressBar: UIView, CAAnimationDelegate {
    ...
    fileprivate func loadFgProgressBar() {
        ...
        let gradientMaskLayer = gradientMaskFg()
    ...
    fileprivate func gradientMaskFg() -> CAGradientLayer {
    ...
    //MARK -- Set timer
    public func setProgressBar(seconds: Int) {
        let totalSeconds = seconds
        timerDuration = totalSeconds
    }
    
    //MARK -- Timer kontrol (PUBLIC)
    public func start() {
